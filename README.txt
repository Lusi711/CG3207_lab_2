...
Decoder.v (Jenny) - Combines submodules Main Decoder, ALU Decoder and PC logic. Sets wires Branch and ALUOp. Outputs PCS, RegW, MemW, MemtoReg, ALUSrc, ImmSrc, RegSrc, ALUControl and FlagW. 
