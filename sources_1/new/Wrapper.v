...
//----------------------------------------------------------------
initial begin
    	INSTR_MEM[0] = 32'hE59F5214; 
	INSTR_MEM[1] = 32'hE59F61F8; 
	INSTR_MEM[2] = 32'hE59F71F8; 
	INSTR_MEM[3] = 32'hE59F8204; 
	INSTR_MEM[4] = 32'hE5065004; 
	INSTR_MEM[5] = 32'hE5961004; 
	INSTR_MEM[6] = 32'hE3710000; 
	INSTR_MEM[7] = 32'h0AFFFFFB; 
	INSTR_MEM[8] = 32'hE5962000; 
	INSTR_MEM[9] = 32'hE5882000; 
	INSTR_MEM[10] = 32'hE3720000; 
	INSTR_MEM[11] = 32'h0AFFFFFB; 
	INSTR_MEM[12] = 32'hE5971000; 
	INSTR_MEM[13] = 32'hE3710000; 
	INSTR_MEM[14] = 32'h0AFFFFFC; 
	INSTR_MEM[15] = 32'hE5963000; 
	INSTR_MEM[16] = 32'hE5883000; 
	INSTR_MEM[17] = 32'hE3730000; 
	INSTR_MEM[18] = 32'h0AFFFFFB; 
	INSTR_MEM[19] = 32'hE3510002; 
	INSTR_MEM[20] = 32'h4A000001; 
	INSTR_MEM[21] = 32'h0A000010; 
	INSTR_MEM[22] = 32'h1A00000B; 
	INSTR_MEM[23] = 32'hE0824003; 
	INSTR_MEM[24] = 32'hE5884000; 
	INSTR_MEM[25] = 32'hE5061004; 
	INSTR_MEM[26] = 32'hEAFFFFE8; 
	INSTR_MEM[27] = 32'hE1824003; 
	INSTR_MEM[28] = 32'hE5884000; 
	INSTR_MEM[29] = 32'hE5061004; 
	INSTR_MEM[30] = 32'hEAFFFFE4; 
	INSTR_MEM[31] = 32'hE0824423; 
	INSTR_MEM[32] = 32'hE5884000; 
	INSTR_MEM[33] = 32'hE5061004; 
	INSTR_MEM[34] = 32'hEAFFFFE0; 
	INSTR_MEM[35] = 32'hE0245392; 
	INSTR_MEM[36] = 32'hE5884000; 
	INSTR_MEM[37] = 32'hE5061004; 
	INSTR_MEM[38] = 32'hEAFFFFDC; 
	INSTR_MEM[39] = 32'hE0040392; 
	INSTR_MEM[40] = 32'hE5884000; 
	INSTR_MEM[41] = 32'hE5061004; 
	INSTR_MEM[42] = 32'hEAFFFFD8; 
	INSTR_MEM[43] = 32'hEAFFFFFE; 
