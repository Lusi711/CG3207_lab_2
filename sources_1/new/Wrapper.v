...
//----------------------------------------------------------------
initial begin
	INSTR_MEM[0] = 32'hE59F61F8; 
	INSTR_MEM[1] = 32'hE59F71F8; 
	INSTR_MEM[2] = 32'hE59F81F8; 
	INSTR_MEM[3] = 32'hE59F9204; 
	INSTR_MEM[4] = 32'hE3A05000; 
	INSTR_MEM[5] = 32'hE5981000; 
	INSTR_MEM[6] = 32'hE5861000; 
	INSTR_MEM[7] = 32'hE1710005; 
	INSTR_MEM[8] = 32'h0AFFFFFB; 
	INSTR_MEM[9] = 32'hE5972000; 
	INSTR_MEM[10] = 32'hE5892000; 
	INSTR_MEM[11] = 32'hE1520005; 
	INSTR_MEM[12] = 32'h0AFFFFFB; 
	INSTR_MEM[13] = 32'hE5865000; 
	INSTR_MEM[14] = 32'hE5981000; 
	INSTR_MEM[15] = 32'hE5861000; 
	INSTR_MEM[16] = 32'hE311027F; 
	INSTR_MEM[17] = 32'h0AFFFFFA; 
	INSTR_MEM[18] = 32'hE5973000; 
	INSTR_MEM[19] = 32'hE5893000; 
	INSTR_MEM[20] = 32'hE1330005; 
	INSTR_MEM[21] = 32'h0AFFFFFB; 
	INSTR_MEM[22] = 32'hE3510002; 
	INSTR_MEM[23] = 32'h4A000001; 
	INSTR_MEM[24] = 32'h0A000018; 
	INSTR_MEM[25] = 32'h1A000021; 
	INSTR_MEM[26] = 32'hE0924003; 
	INSTR_MEM[27] = 32'hE5894000; 
	INSTR_MEM[28] = 32'hE0A24003; 
	INSTR_MEM[29] = 32'hE5894000; 
	INSTR_MEM[30] = 32'hE0524003; 
	INSTR_MEM[31] = 32'hE5894000; 
	INSTR_MEM[32] = 32'hE0C24003; 
	INSTR_MEM[33] = 32'hE5894000; 
	INSTR_MEM[34] = 32'hE0724003; 
	INSTR_MEM[35] = 32'hE5894000; 
	INSTR_MEM[36] = 32'hE0E24003; 
	INSTR_MEM[37] = 32'hE5894000; 
	INSTR_MEM[38] = 32'hE0024003; 
	INSTR_MEM[39] = 32'hE5894000; 
	INSTR_MEM[40] = 32'hE1824003; 
	INSTR_MEM[41] = 32'hE5894000; 
	INSTR_MEM[42] = 32'hE0224003; 
	INSTR_MEM[43] = 32'hE5894000; 
	INSTR_MEM[44] = 32'hE1E04002; 
	INSTR_MEM[45] = 32'hE5894000; 
	INSTR_MEM[46] = 32'hE1C24003; 
	INSTR_MEM[47] = 32'hE5894000; 
	INSTR_MEM[48] = 32'hE5075004; 
	INSTR_MEM[49] = 32'hEAFFFFD2; 
	INSTR_MEM[50] = 32'hE0824103; 
	INSTR_MEM[51] = 32'hE5894000; 
	INSTR_MEM[52] = 32'hE0424123; 
	INSTR_MEM[53] = 32'hE5894000; 
	INSTR_MEM[54] = 32'hE0624143; 
	INSTR_MEM[55] = 32'hE5894000; 
	INSTR_MEM[56] = 32'hE1C24163; 
	INSTR_MEM[57] = 32'hE5894000; 
	INSTR_MEM[58] = 32'hE5075004; 
	INSTR_MEM[59] = 32'hEAFFFFC8; 
	INSTR_MEM[60] = 32'hE0024103; 
	INSTR_MEM[61] = 32'hE5894000; 
	INSTR_MEM[62] = 32'hE1824123; 
	INSTR_MEM[63] = 32'hE5894000; 
	INSTR_MEM[64] = 32'hE0224143; 
	INSTR_MEM[65] = 32'hE5894000; 
	INSTR_MEM[66] = 32'hE1C24163; 
	INSTR_MEM[67] = 32'hE5894000; 
	INSTR_MEM[68] = 32'hE5071004; 
	INSTR_MEM[69] = 32'hEAFFFFBE; 
	INSTR_MEM[70] = 32'hEAFFFFFE; 
	for(i = 71; i < 128; i = i+1) begin 
		INSTR_MEM[i] = 32'h0; 
	end
end
