...
initial begin
	...
	INSTR_MEM[20] = 32'hE3510002; 
	INSTR_MEM[21] = 32'h4A000001; 
	INSTR_MEM[22] = 32'h0A000006; 
	INSTR_MEM[23] = 32'h1A000002; 
	INSTR_MEM[24] = 32'hE0024003; 
	INSTR_MEM[25] = 32'hE58A4000; 
	INSTR_MEM[26] = 32'hEAFFFFE9; 
	INSTR_MEM[27] = 32'hE1824003; 
	INSTR_MEM[28] = 32'hE58A4000; 
	INSTR_MEM[29] = 32'hEAFFFFE6; 
	INSTR_MEM[30] = 32'hE0824423; 
	INSTR_MEM[31] = 32'hE58A4000; 
	INSTR_MEM[32] = 32'hEAFFFFE3; 
	INSTR_MEM[33] = 32'hEAFFFFFE; 
	for(i = 34; i < 128; i = i+1) begin 
		INSTR_MEM[i] = 32'h0; 
	end
end
